...
var addToList = e => {
  e.preventDefault();
  setNewListItem([...newListItem, "We recieved feedback from "+ input.current.value+'  '+ "and his/her email id is "+ input1.current.value+" and mobile number is "+ input3.current.value+". The suggestion/s provided is/are "+"The rating is "+ratingvalue +input2.current.value+ "."  ]);
};
      ...
      <form onSubmit={addToList}>
       <Modal.Body>
        <Form.Group>
          ...
          <br></br>
          <br />
          <input type="text" ref={input} placeholder="Name" style={{width: "300px",height:"50px"}} required/>
          <br></br>
          <br></br>
          <input type="text" ref={input1} placeholder="Email"   style={{width: "300px",height:"50px"}} required/>
          <br></br>
          <br></br>
